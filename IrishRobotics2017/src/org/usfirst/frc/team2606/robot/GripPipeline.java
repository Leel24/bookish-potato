...
public class GripPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double blurRadius = 3.39622641509434;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step RGB_Threshold0:
		Mat rgbThreshold0Input = blurOutput;
		double[] rgbThreshold0Red = {0.0, 45.909090909090914};
		double[] rgbThreshold0Green = {14.406779661016945, 255.0};
		double[] rgbThreshold0Blue = {52.82485875706214, 255.0};
		rgbThreshold(rgbThreshold0Input, rgbThreshold0Red, rgbThreshold0Green, rgbThreshold0Blue, rgbThreshold0Output);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = blurOutput;
		double[] hsvThresholdHue = {0.0, 171.97860962566844};
		double[] hsvThresholdSaturation = {112.85310734463276, 255.0};
		double[] hsvThresholdValue = {31.214689265536723, 255.0};
		hsvThreshold(hsvThresholdInput, hsvThresholdHue, hsvThresholdSaturation, hsvThresholdValue, hsvThresholdOutput);

		// Step HSL_Threshold0:
		Mat hslThreshold0Input = blurOutput;
		double[] hslThreshold0Hue = {0.0, 180.0};
		double[] hslThreshold0Saturation = {184.88700564971748, 255.0};
		double[] hslThreshold0Luminance = {21.610169491525422, 255.0};
		...
		// Step Normalize0:
		Mat normalizeInput = cvSubtractOutput;
